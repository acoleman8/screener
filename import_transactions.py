...
if incremental == 0:
    ...
    cur.execute(
        "create table if not exists Transactions (Date DATETIME, Product VARCHAR, ISIN VARCHAR, Exchange VARCHAR, Number INTEGER, Currency DECIMAL, Price DECIMAL, Value DECIMAL);")
...
with open(file, newline='') as csvfile:
    ...
    for row in reader:
        if i > 0:
            ...
            cur.execute("insert into Transactions values (:v0,:v1,:v2,:v3,:v4,:v5,:v6,:v7)",
