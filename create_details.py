...
cur.execute("create table if not exists Details (ISIN VARCHAR, Symbol VARCHAR, Exchange VARCHAR, Name VARCHAR, Market_Cap VARCHAR, Target_Price FLOAT, Current_Price FLOAT, PE FLOAT, PB FLOAT, PEG FLOAT, MA50 FLOAT, MA200 FLOAT)")
...
for row in result:
    ...
    cur.execute('Insert into Details values (:v0,:v1,:v2,:v3,:v4,:v5,:v6,:v7,:v8,:v9,:v10,:v11)',
                {'v0':ISIN,'v1': symbol,'v2': exchange,'v3': name,'v4': marketCap,'v5': targetPrice,'v6': currentPrice,'v7': pe,'v8': pb,'v9': peg,'v10': ma50,'v11': ma200})
