...
cur.execute(
    'Select AvgPrice.Ticker, AvgPrice, Portfolio.Closing from AvgPrice left join Identifiers on AvgPrice.Ticker = Identifiers.Symbol left join Portfolio on Identifiers.ISIN = Portfolio.ISIN ')
result = cur.fetchall()
